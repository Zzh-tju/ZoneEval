...
from mmdet.core import (anchor_inside_flags, bbox_overlaps, build_assigner, bbox_xyxy_to_cxcywh,
...
class GFLSELAHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.reg_max = reg_max
        self.gamma = gamma
        super(GFLSELAHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, labels, label_weights, spatial_weights,
        ...
        if len(pos_inds) > 0:
            ...
            if self.gamma is not None:
                weight_targets = weight_targets * (spatial_weights[pos_inds] * self.gamma + 1)	# cost sensitive learning SELA
    ...
    def loss(self,
        ...
        (anchor_list, labels_list, label_weights_list, bbox_targets_list,
         bbox_weights_list, spatial_weights_list, num_total_pos, num_total_neg) = cls_reg_targets
    ...
    def _get_zone_bboxes_single(self,
                           cls_score_list,
                           bbox_pred_list,
                           score_factor_list,
                           mlvl_priors,
        ...
        return self._zone_bbox_post_process(mlvl_scores, mlvl_labels, mlvl_bboxes,
                                       img_meta['scale_factor'], cfg, ri, rj, www, hhh, rescale,
