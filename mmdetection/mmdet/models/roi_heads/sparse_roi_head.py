...
class SparseRoIHead(CascadeRoIHead):
    ...
    def simple_zone_test(self,
        ...
        for img_id in range(num_imgs):
            ...
            bbox_pred_per_img = proposal_list[img_id][topk_indices //
                                                      num_classes]
            img_w = img_metas[img_id]['img_shape'][1]
            img_h = img_metas[img_id]['img_shape'][0]
            if rescale:
                scale_factor = img_metas[img_id]['scale_factor']
                img_w /= scale_factor[0]
                img_h /= scale_factor[1]
                bbox_pred_per_img /= bbox_pred_per_img.new_tensor(scale_factor)
            xywh_det = bbox_xyxy_to_cxcywh(bbox_pred_per_img)
            ...
            ind2 = ind0 & ind1
            bbox_pred_per_img=bbox_pred_per_img[ind2]
            scores_per_img=scores_per_img[ind2]
            labels_per_img=labels_per_img[ind2]
