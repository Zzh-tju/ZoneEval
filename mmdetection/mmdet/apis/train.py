...
def train_detector(model,
    ...
    if validate:
        ...
        zone_eval= cfg.model.test_cfg.zone_eval
        eval_metric = cfg.evaluation.metric
        num_class = cfg.model.bbox_head.num_classes
        runner.register_hook(
            eval_hook(val_dataloader, **eval_cfg, zone_eval=(zone_eval, cfg.evaluation.metric, num_class)), priority='LOW')
